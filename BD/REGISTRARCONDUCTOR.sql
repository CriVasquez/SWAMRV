...
v_fechare conductor.fecha_retiro%type,
...
is
BEGIN
INSERT INTO CONDUCTOR(rut_conductor,nombre,apellido_paterno,apellido_materno, direccion, telefono, email, id_comuna, fecha_ingreso, fecha_retiro, fecha_nacimiento, radio, licencia, detalle, foto) 
VALUES (v_rut, v_nombre, v_apepa, v_apema, v_dire, v_tele, v_email, v_id_comuna, v_fechain, v_fechare, v_fechana, v_radio, v_licen, v_detall, v_foto);
