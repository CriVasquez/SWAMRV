...
v_fecharet vehiculo.fecha_retiro%type,
v_foto vehiculo.foto%type)

is
BEGIN
INSERT INTO VEHICULO(patente, chasis, ano, color, marca, modelo, fecha_ingreso, fecha_retiro, foto) 
VALUES (v_patente, v_chasis, v_ano, v_color, v_marca, v_modelo, v_fechain, v_fecharet ,v_foto);
